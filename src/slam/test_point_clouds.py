...
def apply_translation_and_rotation(points: np.ndarray, translation: np.ndarray, rotation: np.ndarray) -> np.ndarray:
    """
    Applies translation and rotation to a set of points.
    """
